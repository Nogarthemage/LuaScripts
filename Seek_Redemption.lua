...
function Script.Zenn_OnConcludeQuest(Unit, QuestId, Player)
	if QuestId == 489 then
		...
		Unit:SetRandomMovementSpeed(8) -- making the frog run faster
	end
end

function Script.Zenn_OnRemoveAura(Unit, AuraId)
...
RegisterUnitEvent(2150, 17,  Script.Zenn_OnConcludeQuest)
RegisterUnitEvent(2150, 21,  Script.Zenn_OnRemoveAura)
